...
const UniversityDetailsPage: React.FC = () => {
  ...
  const selectedSpecialty = searchParams.get('specialty') || location.state?.selectedSpecialty || "Toutes les spécialités";
  ...
  const getFilteredSpecialties = () => {
    if (!university || selectedSpecialty === "Toutes les spécialités") {
    ...
    return (
      <div className="min-h-screen bg-slate-50 pt-20 flex items-center justify-center">
        <div className="text-center">
          <div className="text-2xl font-bold text-slate-800 mb-4">جاري التحميل...</div>
        ...
        <div className="bg-white rounded-xl p-8 border border-slate-200 shadow-sm">
            ...
            <>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg">
                  ...
                  <div>
                    <div className="font-medium text-slate-800">التليفون</div>
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg">
                  ...
                  <div>
                    <div className="font-medium text-slate-800">الإيميل</div>
              ...
              <div className="mb-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-4 bg-indigo-50 rounded-lg">
                    <div className="font-medium text-indigo-800 mb-2"> </div>
                    <div className="text-indigo-700">{university.university}</div>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <div className="font-medium text-purple-800 mb-2">الموقع الرسمي</div>
                    <a 
          ...
          {activeTab === 'specialties' && (
            <>
              {/* Detailed Scores */}
              <div className="mb-8">
                <h3 className="text-2xl font-bold text-slate-800 mb-6">نقاط القبول {university.lastYearScores.year}</h3>
                  ...
                  {getFilteredScores().map((score, index) => (
                    <div key={index} className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-6 border border-indigo-200">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-sm text-slate-600 bg-white px-3 py-1 rounded-full">{score.places} مقعد</span>
                      </div>
                      <div className="text-center">
                        <div className="text-4xl font-bold text-indigo-600 mb-2">{score.lastAcceptableScore}</div>
                        <div className="text-sm text-slate-600">آخر نقطة مقبولة</div>
                        <div className="text-xs text-slate-500 mt-1">سنة {university.lastYearScores.year}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold text-slate-800 mb-6">خطط الدراسة حسب التخصص</h3>
                <div className="grid gap-6">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-slate-500">
                            ...
                            <span>المدة: {specialty.duration}</span>
                            <span>السعة: {specialty.capacity} طالب</span>
                          </div>
                        </div>
            ...
            <>
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-slate-800 mb-6">موقع الجامعة</h3>
